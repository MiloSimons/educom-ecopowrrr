 ...
 */
final class Version20241125144605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE monthly_used (id INT AUTO_INCREMENT NOT NULL, overall_device_id INT NOT NULL, date DATE NOT NULL, monthly_kw_hused DOUBLE PRECISION NOT NULL, INDEX IDX_ED104AE51486EB09 (overall_device_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE overall_device (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, status_id INT NOT NULL, UNIQUE INDEX UNIQ_691A371219EB6921 (client_id), INDEX IDX_691A37126BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE monthly_used ADD CONSTRAINT FK_ED104AE51486EB09 FOREIGN KEY (overall_device_id) REFERENCES overall_device (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE monthly_used DROP FOREIGN KEY FK_ED104AE51486EB09');
        ...
        $this->addSql('DROP TABLE monthly_used');
